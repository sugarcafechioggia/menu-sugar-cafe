...
Al termine della generazione, il PDF viene inviato anche alla chat Telegram configurata tramite i segreti `TELEGRAM_BOT_TOKEN` e `TELEGRAM_CHAT_ID`. Il nome dell'allegato contiene data e ora di produzione nel fuso orario `Europe/Rome`.
